...
public:
    ...
    void setupUi(QDialog *UIAbout)
    {
        ...
        UIAbout->resize(711, 192);
        ButtonOK = new QPushButton(UIAbout);
        ButtonOK->setObjectName(QStringLiteral("ButtonOK"));
        ButtonOK->setGeometry(QRect(590, 120, 101, 31));
    ...
    {
        UIAbout->setWindowTitle(QApplication::translate("UIAbout", "\345\205\263\344\272\216", Q_NULLPTR));
        ButtonOK->setText(QApplication::translate("UIAbout", "OK", Q_NULLPTR));
